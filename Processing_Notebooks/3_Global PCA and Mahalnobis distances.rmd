...
test_chem_res <- test_chem_res %>%
  filter(!paste(chem, concentration) %in% paste(cytotoxic_conc$Metadata_Chemical, cytotoxic_conc$Metadata_Concentration))
...
ggsave(
  filename = file.path(plots, "Global_BMC.png"),
